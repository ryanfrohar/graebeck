      ...
      <div>
        ...
        <div class="social-links">
          <a href="https://www.linkedin.com/company/graebeck-construction" aria-label="Graebeck on LinkedIn" rel="noopener noreferrer" target="_blank" class="social-link-item">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M2 9h4v12H2zM4 2a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/></svg>
          </a>
        </div>
      </div>
